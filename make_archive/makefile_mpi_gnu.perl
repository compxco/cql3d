...
#(If needed: module load cray-netcdf; module load cray-hdf5)
...
# ```
# LOCATION= -L/global/cfs/cdirs/m77/CompX/pgplot/pgplot.perl.gnu
# (or whatever the path is)
# ```
# Also add into your batchscript_mpi  file, just before srun line:
#  export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/global/cfs/cdirs/m77/CompX/pgplot/pgplot.perl.gnu
# --------------------------------------------------------
...
CSPECIAL   = -fallow-argument-mismatch -std=legacy -fno-align-commons
